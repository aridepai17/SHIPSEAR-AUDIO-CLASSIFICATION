...
The model demonstrated steady and stable learning throughout the training process:

* **After Epoch 1:** Training accuracy reached 36.75% with a validation accuracy of 42.57% (Val Loss: 1.5146).
* **After Epoch 5:** Training accuracy significantly improved to 56.11% with a validation accuracy of 58.33% (Val Loss: 1.0993).
* **Peak (Epoch 47):** Validation accuracy peaked at **96.86%**, with validation loss dropping to its lowest at **0.0931**.
